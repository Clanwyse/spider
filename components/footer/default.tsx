...
const navigation = {
  ...
  social: [
    {
      name: "LinkedIn",
      href: "https://www.linkedin.com/company/clanwyse",
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/clanwyse",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "GitHub",
      href: "https://github.com/Clanwyse",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@Clanwyse",
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
...
export default function FooterDefault() {
  return (
    <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 md:flex md:items-center md:justify-between lg:mt-12">
      ...
      <div className="flex gap-4">
        <Link
          href={"/terms"}
          target="_blank"
          className="mt-8 text-sm leading-5 text-gray-500 md:order-1 md:mt-0"
        >
          Terms
        </Link>
        <Link
